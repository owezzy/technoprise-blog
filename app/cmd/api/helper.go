...
func (app *application) readFilenameParam(r *http.Request) string {
	params := httprouter.ParamsFromContext(r.Context())
	return params.ByName("filename")
}
	...
	go func() {
		...
		defer func() {
			if err := recover(); err != nil {
				app.logger.Error(context.Background(), "background goroutine panic",
